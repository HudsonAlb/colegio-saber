    ...
    <div className="page-home">
      ...
      <section className="py-20 bg-brand-light border-t border-brand-light-border relative z-10">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-8 rounded-3xl border border-brand-light-border bg-brand-light-card hover:shadow-lg transition-shadow duration-500 flex flex-col justify-between h-64">
